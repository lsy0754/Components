"""
components appComponent module.

This is the module of components containing DALiuGE application components.
...
# @param[in] param/appclass Application Class/components.MyApp/String/readonly/
